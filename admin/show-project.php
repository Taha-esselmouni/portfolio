  ...
  <thead>
    ...
    <tbody>
      <?php 
          ...
          $load_projet_query = mysqli_query($connection,$sql);
          ...
          if (isset($_GET['delete'])) {
              $delete_projet_id = $_GET['delete'];

              $delete_query = "DELETE FROM projet WHERE id = $delete_projet_id";
              $delete_projet_query = mysqli_query($connection,$delete_query);
